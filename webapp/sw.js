const CACHE_NAME = "right-finder-ui5-v2.0.1";
...
const cdnBase = "https://openui5.hana.ondemand.com/1.75.7/resources/";
RESOURCES_TO_PRELOAD = RESOURCES_TO_PRELOAD.concat([
    ...
    `${cdnBase}sap/ui/core/messagebundle_en_US.properties`,
	`${cdnBase}sap/m/messagebundle_en.properties`,
    `${cdnBase}sap/m/messagebundle_en_US.properties`,
	`${cdnBase}sap/ui/layout/messagebundle.properties`,
	`${cdnBase}sap/ui/layout/messagebundle_en.properties`,
    `${cdnBase}sap/ui/layout/messagebundle_en_US.properties`,
...
self.addEventListener("fetch", function (event) {
	...
	if (event.request.method === "GET" && event.request.url.indexOf("us-west-1.amazonaws.com") < 0) {
		event.respondWith(
